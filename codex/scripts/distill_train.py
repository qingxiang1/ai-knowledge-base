...
def parse_args():
    parser = argparse.ArgumentParser(description="Train a student model on distilled data.")
...
def main():
    ...
    print(f"Distillation training finished. Artifacts saved to {config['output_dir']}")
