...
> **历史示例说明（2026-08-18）**：本文部分代码使用旧时期的 Model ID/API 示例。它们用于学习请求、流式输出、工具与多模态结构，不构成当前生产推荐。请在实施前查阅 [OpenAI API 官方文档](https://developers.openai.com/api/docs/) 并完成 [模型版本与价格核对](../04-大模型生态/模型版本与价格核对表.md)。
